...
`confidantic/context.py`, `confidantic/logging.py`, `confidantic/paths.py`, and
the package root. Internal configuration primitives live in
`confidantic/_config/`, which contains base and factory configuration.
